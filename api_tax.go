...
func (a *TaxApiService) GetTaxClasses(ctx context.Context, localVarOptionals *TaxApiGetTaxClassesOpts) ([]GxTaxClass, *http.Response, error) {
	var (
...
func (a *TaxApiService) GetTaxRates(ctx context.Context, localVarOptionals *TaxApiGetTaxRatesOpts) ([]GxTaxClassRate, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *TaxApiService) GetTaxZones(ctx context.Context, localVarOptionals *TaxApiGetTaxZonesOpts) ([]GxTaxZone, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
