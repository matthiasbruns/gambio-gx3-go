...
*/
func (a *OrderStatusesApiService) CreateOrderStatuses(ctx context.Context, body GxOrderStatus) (
	GxOrderStatus,
	*http.Response,
	error,
) {
...
*/
func (a *OrderStatusesApiService) DeleteOrderStatuses(
	ctx context.Context,
	orderStatusId int64,
) (DefaultSuccessResponseWithOrderStatusId, *http.Response, error) {
	var (
...
@return GxOrderStatus
*/
func (a *OrderStatusesApiService) GetOrderStatus(ctx context.Context, orderStatusId int64) (
	GxOrderStatus,
	*http.Response,
	error,
) {
...
func (a *OrderStatusesApiService) GetOrderStatuses(
	ctx context.Context,
	localVarOptionals *OrderStatusesApiGetOrderStatusesOpts,
...
@return GxOrderStatus
*/
func (a *OrderStatusesApiService) UpdateOrderStatuses(
	ctx context.Context,
	body GxOrderStatus,
	orderStatusId int64,
) (GxOrderStatus, *http.Response, error) {
