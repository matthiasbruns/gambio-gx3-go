...
*/
func (a *EmailsApiService) DeleteEmail(ctx context.Context, emailId int64) (
...
@return GxCustomerEmail
*/
func (a *EmailsApiService) QueueEmail(ctx context.Context, body GxCustomerEmail) (
	GxCustomerEmail,
	*http.Response,
	error,
) {
...
func (a *EmailsApiService) SendEmail(
	ctx context.Context,
	emailId int64,
	localVarOptionals *EmailsApiSendEmailOpts,
) (GxCustomerEmail, *http.Response, error) {
	var (
