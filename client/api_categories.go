...
*/
func (a *CategoriesApiService) CreateCategories(ctx context.Context, body []GxCategoryArray) (
...
*/
func (a *CategoriesApiService) DeleteCategories(
	ctx context.Context,
	categoryIds []int64,
) (CategoryDeleteSuccessResponse, *http.Response, error) {
	var (
...
func (a *CategoriesApiService) GetCategories(
	ctx context.Context,
	localVarOptionals *CategoriesApiGetCategoriesOpts,
) ([]GxCategoryListingEntity, *http.Response, error) {
	var (
...
func (a *CategoriesApiService) GetCategoriyProducts(
	ctx context.Context,
	categoryId int64,
	localVarOptionals *CategoriesApiGetCategoriyProductsOpts,
) ([]GxProduct, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []GxCategoryListingEntity
*/
func (a *CategoriesApiService) GetCategoryChildren(ctx context.Context, categoryId int64) (
...
@return []GxCategory
*/
func (a *CategoriesApiService) SearchCategories(ctx context.Context, body SearchCondition) (
	[]GxCategory,
	*http.Response,
	error,
) {
...
*/
func (a *CategoriesApiService) UpdateCategories(ctx context.Context, body []GxCategoryArray) (
...
@return GxCategory
*/
func (a *CategoriesApiService) UpdateCategory(ctx context.Context, body GxCategory, categoryId int64) (
	GxCategory,
	*http.Response,
	error,
) {
