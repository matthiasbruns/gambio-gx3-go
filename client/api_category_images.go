...
*/
func (a *CategoryImagesApiService) DeleteCategoryImages(ctx context.Context) (
...
func (a *CategoryImagesApiService) GetCategoryImages(
	ctx context.Context,
	localVarOptionals *CategoryImagesApiGetCategoryImagesOpts,
) (CategoryImageGetResponse, *http.Response, error) {
	var (
...
*/
func (a *CategoryImagesApiService) RenameCategoryImages(ctx context.Context) (
...
@return DefaultSuccessResponseWithFilename
*/
func (a *CategoryImagesApiService) UploadCategoryImages(
	ctx context.Context,
	uploadCategoryImage *os.File,
	filename string,
