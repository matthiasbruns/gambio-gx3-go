...
*/
func (a *ReviewsApiService) DeleteReviews(ctx context.Context, reviewId int64) (
...
func (a *ReviewsApiService) GetReviews(ctx context.Context, localVarOptionals *ReviewsApiGetReviewsOpts) (
	[]GxReview,
	*http.Response,
	error,
) {
...
@return []GxReview
*/
func (a *ReviewsApiService) UpdateReviews(ctx context.Context, body GxReview, reviewId int64) (
	[]GxReview,
	*http.Response,
	error,
) {
