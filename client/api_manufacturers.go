...
*/
func (a *ManufacturersApiService) CreateManufacturers(ctx context.Context, body GxManufacturer) (
	GxManufacturer,
	*http.Response,
	error,
) {
...
*/
func (a *ManufacturersApiService) DeleteManufacturers(
	ctx context.Context,
	manufacturerId int64,
) (DefaultSuccessResponseWithManufacturersId, *http.Response, error) {
	var (
...
@return GxManufacturer
*/
func (a *ManufacturersApiService) GetManufacturer(ctx context.Context, manufacturerId int64) (
	GxManufacturer,
	*http.Response,
	error,
) {
...
func (a *ManufacturersApiService) GetMultipleManufacturers(
	ctx context.Context,
	localVarOptionals *ManufacturersApiGetMultipleManufacturersOpts,
) ([]GxManufacturer, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ManufacturersApiService) SearchManufacturers(
	ctx context.Context,
	body SearchCondition,
	localVarOptionals *ManufacturersApiSearchManufacturersOpts,
) ([]GxCategory, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GxManufacturer
*/
func (a *ManufacturersApiService) UpdateManufacturers(
	ctx context.Context,
	body GxManufacturer,
	manufacturerId int64,
) (GxManufacturer, *http.Response, error) {
