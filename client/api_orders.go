...
@return GxOrderItem
*/
func (a *OrdersApiService) CreateOrderItem(ctx context.Context, body GxOrderItem, orderId int64) (
	GxOrderItem,
	*http.Response,
	error,
) {
...
*/
func (a *OrdersApiService) CreateOrderTimeAttribute(
	ctx context.Context,
	body GxOrderItemAttributes,
	orderId int64,
	itemId int64,
) (GxOrderItemAttributes, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GxOrderTotal
*/
func (a *OrdersApiService) CreateOrderTotal(ctx context.Context, body GxOrderTotal, orderId int64) (
	GxOrderTotal,
	*http.Response,
	error,
) {
...
*/
func (a *OrdersApiService) DeleteOrderItems(
	ctx context.Context,
	orderId int64,
	itemId int64,
) (DefaultSuccessResponseWithOrderIdAndOrderItemId, *http.Response, error) {
	var (
...
*/
func (a *OrdersApiService) DeleteOrderTotals(
	ctx context.Context,
	orderId int64,
	totalId int64,
) (DefaultSuccessResponseWithOrderIdAndOrderTotalId, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *OrdersApiService) DeleteOrders(ctx context.Context, orderId int64) (
...
*/
func (a *OrdersApiService) GetOrderHistories(ctx context.Context, orderId int64) (
...
@return GxOrderStatusHistory
*/
func (a *OrdersApiService) GetOrderHistory(ctx context.Context, orderId int64, historyId int64) (
	GxOrderStatusHistory,
	*http.Response,
	error,
) {
...
@return GxOrderItem
*/
func (a *OrdersApiService) GetOrderItem(ctx context.Context, orderId int64, itemId int64) (
	GxOrderItem,
	*http.Response,
	error,
) {
...
*/
func (a *OrdersApiService) GetOrderPaymentDetails(ctx context.Context, orderId int64) (
	GxPaymentDetails,
	*http.Response,
	error,
) {
...
@return GxOrderTotal
*/
func (a *OrdersApiService) GetOrderTotal(ctx context.Context, orderId int64, totalsId int64) (
	GxOrderTotal,
	*http.Response,
	error,
) {
...
*/
func (a *OrdersApiService) GetOrderTrackingCodes(ctx context.Context, orderId int64) (
	[]GxTrackingCode,
	*http.Response,
	error,
) {
...
@return []GxTrackingCode
*/
func (a *OrdersApiService) GetOrderTrackingCodesDeprecated(ctx context.Context, orderId int64) (
	[]GxTrackingCode,
	*http.Response,
	error,
) {
...
@return GxOrderItemAttributes
*/
func (a *OrdersApiService) GetOrdersItemsAttributeProperty(
	ctx context.Context,
	orderId int64,
	itemId int64,
	attributeId int64,
...
@return []GxOrderItemAttributes
*/
func (a *OrdersApiService) GetOrdersItemsAttributesProperty(
	ctx context.Context,
	orderId int64,
	itemId int64,
) ([]GxOrderItemAttributes, *http.Response, error) {
...
func (a *OrdersApiService) GetOrdersMultiple(
	ctx context.Context,
	localVarOptionals *OrdersApiGetOrdersMultipleOpts,
) ([]GxOrderListItem, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []GxTrackingCode
*/
func (a *OrdersApiService) PostTrackingCode(
	ctx context.Context,
	body GxTrackingCodeRequestBody,
	orderId int64,
) ([]GxTrackingCode, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []GxTrackingCode
*/
func (a *OrdersApiService) PostTrackingCodeDeprecated(
	ctx context.Context,
	body GxTrackingCodeRequestBody,
	orderId int64,
) ([]GxTrackingCode, *http.Response, error) {
...
*/
func (a *OrdersApiService) RemoveOrdersItemsAttribute(
	ctx context.Context,
	orderId int64,
	itemId int64,
	attributeId int64,
) (DefaultSuccessResponseWithOrderIdAndOrderItemIdAndOrderItemAttributeId, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []GxOrderListItem
*/
func (a *OrdersApiService) SearchOrders(ctx context.Context, body SearchCondition) (
	[]GxOrderListItem,
	*http.Response,
	error,
) {
...
@return GxOrderItem
*/
func (a *OrdersApiService) UpdateOrderItems(
	ctx context.Context,
	body GxOrderItem,
	orderId int64,
	itemId int64,
) (GxOrderItem, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *OrdersApiService) UpdateOrderStatus(
	ctx context.Context,
	body GxOrderStatusHistory,
	orderId int64,
) (GxOrderStatus, *http.Response, error) {
	var (
...
@return GxOrderTotal
*/
func (a *OrdersApiService) UpdateOrderTotal(
	ctx context.Context,
	body GxOrderTotal,
	orderId int64,
	totalId int64,
) (GxOrderTotal, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GxOrderItemAttributes
*/
func (a *OrdersApiService) UpdateOrdersItemsAttributesProperty(
	ctx context.Context,
	body GxOrderItemAttributes,
	orderId int64,
	itemId int64,
