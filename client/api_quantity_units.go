...
*/
func (a *QuantityUnitsApiService) CreateQuantityUnits(ctx context.Context, body GxQuantityUnit) (
	GxQuantityUnit,
	*http.Response,
	error,
) {
...
*/
func (a *QuantityUnitsApiService) DeleteQuantityUnits(
	ctx context.Context,
	quantityUnitId int64,
) (DefaultSuccessResponseWithQuantityUnitId, *http.Response, error) {
	var (
...
@return GxQuantityUnit
*/
func (a *QuantityUnitsApiService) GetQuantityUnit(ctx context.Context, quantityUnitId int64) (
	GxQuantityUnit,
	*http.Response,
	error,
) {
...
func (a *QuantityUnitsApiService) GetQuantityUnits(
	ctx context.Context,
	localVarOptionals *QuantityUnitsApiGetQuantityUnitsOpts,
) ([]GxQuantityUnit, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GxQuantityUnit
*/
func (a *QuantityUnitsApiService) UpdateQuantityUnitEntity(
	ctx context.Context,
	body GxQuantityUnit,
	quantityUnitId int64,
) (GxQuantityUnit, *http.Response, error) {
