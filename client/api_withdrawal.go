...
*/
func (a *WithdrawalApiService) DeleteWithdrawals(ctx context.Context, withdrawalId int64) (
...
@return []GxWithdrawal
*/
func (a *WithdrawalApiService) GetWithdrawal(ctx context.Context, withdrawalId int64) (
	[]GxWithdrawal,
	*http.Response,
	error,
) {
...
func (a *WithdrawalApiService) GetWithdrawals(
	ctx context.Context,
	localVarOptionals *WithdrawalApiGetWithdrawalsOpts,
) ([]GxWithdrawal, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []GxWithdrawal
*/
func (a *WithdrawalApiService) PostWithdrawals(ctx context.Context, body GxWithdrawal) (
	[]GxWithdrawal,
	*http.Response,
	error,
) {
...
@return []GxWithdrawal
*/
func (a *WithdrawalApiService) UpdateWithdrawals(
	ctx context.Context,
	body GxWithdrawal,
	withdrawalId int64,
) ([]GxWithdrawal, *http.Response, error) {
