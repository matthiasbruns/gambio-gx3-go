...
*/
func (a *TrackingCodesApiService) DeleteTrackingCodes(
	ctx context.Context,
...
*/
func (a *TrackingCodesApiService) GetTrackingCode(ctx context.Context, trackingCodeId int64) (
	[]GxTrackingCode,
	*http.Response,
	error,
) {
...
func (a *TrackingCodesApiService) GetTrackingCodes(
	ctx context.Context,
	localVarOptionals *TrackingCodesApiGetTrackingCodesOpts,
