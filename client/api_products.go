...
*/
func (a *ProductsApiService) CreateProductLink(
	ctx context.Context,
	body ProductCategoryLinkId,
	productId int64,
) (DefaultSuccessResponseWithProductIdAndCategoryId, *http.Response, error) {
	var (
...
*/
func (a *ProductsApiService) CreateProducts(ctx context.Context, body []GxProductArray) (
...
*/
func (a *ProductsApiService) DeleteProductLink(
	ctx context.Context,
	body ProductCategoryLinkId,
	productId int64,
...
*/
func (a *ProductsApiService) DeleteProducts(ctx context.Context, productIds []int64) (
...
*/
func (a *ProductsApiService) GetProductProductPrices(ctx context.Context, productId int64) (
	GxProductPrices,
	*http.Response,
	error,
) {
...
*/
func (a *ProductsApiService) GetProductQuantityPrices(
	ctx context.Context,
	productId int64,
...
func (a *ProductsApiService) GetProducts(
	ctx context.Context,
	localVarOptionals *ProductsApiGetProductsOpts,
) ([]GxProductListing, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return GxProductPrices
*/
func (a *ProductsApiService) PutProductProductPrices(
	ctx context.Context,
...
@return []GxProduct
*/
func (a *ProductsApiService) SearchProducts(ctx context.Context, body SearchCondition) (
	[]GxProduct,
	*http.Response,
	error,
) {
...
@return GxProduct
*/
func (a *ProductsApiService) UpdateProduct(ctx context.Context, body GxProduct, productId int64) (
	GxProduct,
	*http.Response,
	error,
) {
...
*/
func (a *ProductsApiService) UpdateProductLink(
	ctx context.Context,
	body GxProductLinkPutRequest,
	productId int64,
) (DefaultSuccessResponseWithProductIdAndCategoryIDs, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *ProductsApiService) UpdateProducts(ctx context.Context, body []GxProductArray) (
