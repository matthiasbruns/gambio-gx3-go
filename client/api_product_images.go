...
*/
func (a *ProductImagesApiService) DeleteProductImage(ctx context.Context) (
...
func (a *ProductImagesApiService) GetProductImage(
	ctx context.Context,
	localVarOptionals *ProductImagesApiGetProductImageOpts,
...
func (a *ProductImagesApiService) RenameImageFile(
	ctx context.Context,
	localVarOptionals *ProductImagesApiRenameImageFileOpts,
) (DefaultUpdateResponseWithFilenames, *http.Response, error) {
	var (
...
@return DefaultSuccessResponseWithFilename
*/
func (a *ProductImagesApiService) UploadProductImage(
	ctx context.Context,
	uploadProductImage *os.File,
	filename string,
