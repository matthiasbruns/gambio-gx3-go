...
type CategoryImagesApiService service
/*
CategoryImagesApiService Delete Category Image
...
*/
func (a *CategoryImagesApiService) DeleteCategoryImages(ctx context.Context) (DefaultSuccessResponseWithFilename, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/category_images"
...
/*
CategoryImagesApiService Get Category Images
Get a list of all category image files which exists in the server&#x27;s filesystem through a GET request.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CategoryImagesApiGetCategoryImagesOpts - Optional Parameters:
...
@return CategoryImageGetResponse
*/

type CategoryImagesApiGetCategoryImagesOpts struct {
...
func (a *CategoryImagesApiService) GetCategoryImages(ctx context.Context, localVarOptionals *CategoryImagesApiGetCategoryImagesOpts) (CategoryImageGetResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CategoryImageGetResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CategoryImageGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CategoryImagesApiService Rename Image File
Use this method to rename an existing image file.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return DefaultUpdateResponseWithFilenames
*/
func (a *CategoryImagesApiService) RenameCategoryImages(ctx context.Context) (DefaultUpdateResponseWithFilenames, *http.Response, error) {
	var (
...
/*
CategoryImagesApiService Upload Category Image
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uploadCategoryImage
 * @param filename
@return DefaultSuccessResponseWithFilename
*/
func (a *CategoryImagesApiService) UploadCategoryImages(ctx context.Context, uploadCategoryImage *os.File, filename string) (DefaultSuccessResponseWithFilename, *http.Response, error) {
	var (
    ...
    localVarFile := uploadCategoryImage
	if localVarFile != nil {
