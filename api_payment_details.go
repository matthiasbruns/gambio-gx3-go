...
/*
PaymentDetailsApiService Get Payment Details
...
*/
func (a *PaymentDetailsApiService) GetPaymentDetails(ctx context.Context, orderId int64) (GxPaymentDetails, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/payment_details/{order_id}"
