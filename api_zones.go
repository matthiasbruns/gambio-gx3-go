...
@return GxZone
*/
func (a *ZonesApiService) GetZones(ctx context.Context, zoneId int64) (GxZone, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue GxZone
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/zones/{zone_id}"
