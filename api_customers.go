...
*/
func (a *CustomersApiService) CreateCustomers(ctx context.Context, body [][]GxCustomer) (CustomerArrayPostResponse, *http.Response, error) {
	var (
...
*/
func (a *CustomersApiService) DeleteCustomers(ctx context.Context, customerIds []int64) (CustomerArrayDeleteResponse, *http.Response, error) {
	var (
...
func (a *CustomersApiService) GetCustomers(ctx context.Context, localVarOptionals *CustomersApiGetCustomersOpts) ([]GxCustomer, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []GxCustomer
*/
func (a *CustomersApiService) SearchCustomer(ctx context.Context, body SearchCondition) ([]GxCustomer, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return GxCustomer
*/
func (a *CustomersApiService) UpdateCustomer(ctx context.Context, customerId int64) (GxCustomer, *http.Response, error) {
	var (
...
*/
func (a *CustomersApiService) UpdateCustomers(ctx context.Context, body [][]GxCustomer) (CustomerArrayPutResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
