...
*/
func (a *AddressesApiService) DeleteAddress(ctx context.Context, addressId string) (AddressDeleteResponse, *http.Response, error) {
	var (
...
func (a *AddressesApiService) GetAddresses(ctx context.Context, localVarOptionals *AddressesApiGetAddressesOpts) ([]GxAddress, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
