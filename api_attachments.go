...
*/
func (a *AttachmentsApiService) UploadAttachments(ctx context.Context, uploadAttachment *os.File, filename string) (AttachmentSuccessExample, *http.Response, error) {
	var (
